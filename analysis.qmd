...
The final model is represented by the following equation: 
  $$
  \begin{equation}
  \sqrt{var\_measure_i} = 10.6397 - 2.1601*UGDS\_BLACK_i - 1.5554*UGDS\_HISP_i \\ 
  - 2.0451*UGDS\_ASIAN_i + 1.5862*FTFTPCTFLOAN\_POOLED\_SUPP_i \\
  - 6.5651*INC\_PCT\_LO_i - 27.1280*INC\_PCT\_M1_i \\
